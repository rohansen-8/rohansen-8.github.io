...
- Knowledge of the following from university courses as well as from personal projects:
  <dl>
  <dt>Data</dt>
  <dd>Processing (Spark), cleaning (pandas), modelling (TensorFlow, sklearn), analysis & visualization </dd>
  
  <dt>Programming languages</dt> 
  <dd>Python (including NumPy, matplotlib and the use of Jupyter Notebooks), Java, MATLAB, Haskell and  SAS</dd>
